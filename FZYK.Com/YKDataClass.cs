...
namespace FZYK .Com
{
      ...
      public class YKDataClass
      {
            ...
            public static string ConnectionString = Getconnstr();
            ...
            {
                  return Getini("DBConfig", "ConnectionString");
            }

            private static string Getini(string select, string key)
            {
                  string currentpath = Directory .GetCurrentDirectory();
                  string path = currentpath + "\\db.ini";
